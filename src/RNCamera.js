...
export default class Camera extends React.Component<PropsType, StateType> {
  ...
  lockFocus() {
    return CameraManager.lockFocus(this._cameraHandle);
  }
  ...
  getExposureTargetBiasBoundaries() {
    return CameraManager.getExposureTargetBiasBoundaries(this._cameraHandle);
  }

  getISO() {
    return CameraManager.getISO(this._cameraHandle);
  }

  getExposure() {
    return CameraManager.getExposure(this._cameraHandle);
  }

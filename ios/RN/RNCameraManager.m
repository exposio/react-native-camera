...
RCT_EXPORT_METHOD(lockFocus:(nonnull NSNumber *)reactTag
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(unlockFocus:(nonnull NSNumber *)reactTag
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(lockAutoExposure:(nonnull NSNumber *)reactTag
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [self.bridge.uiManager addUIBlock:^(__unused RCTUIManager *uiManager, NSDictionary<NSNumber *, RNCamera *> *viewRegistry) {
        RNCamera *view = viewRegistry[reactTag];
        if (![view isKindOfClass:[RNCamera class]]) {
            ...
            [view setExposureMode:AVCaptureExposureModeAutoExpose];
            [view updateExposure];
            resolve(@YES);
        }
    }];
...
RCT_EXPORT_METHOD(unlockAutoExposure:(nonnull NSNumber *)reactTag
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    [self.bridge.uiManager addUIBlock:^(__unused RCTUIManager *uiManager, NSDictionary<NSNumber *, RNCamera *> *viewRegistry) {
        RNCamera *view = viewRegistry[reactTag];
...
RCT_EXPORT_METHOD(getISO:(nonnull NSNumber *)reactTag
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    #if TARGET_IPHONE_SIMULATOR
        reject(@"E_GET_ISO_FAILED", @"ISO is not supported on a simulator.", nil);
        return;
    #endif
    ...
    [self.bridge.uiManager addUIBlock:^(__unused RCTUIManager *uiManager, NSDictionary<NSNumber *, RNCamera *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[RNCamera class]]) {
            ...
            float isoValue = [view getISO];
            if (isoValue != 0) {
                resolve(@(isoValue));
            } else {
                reject(@"E_GET_ISO_FAILED", @"ISO not found or is zero.", nil);
            }
        }
    }];
}

RCT_EXPORT_METHOD(getExposure:(nonnull NSNumber *)reactTag
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    #if TARGET_IPHONE_SIMULATOR
        reject(@"E_GET_EXPOSURE_FAILED", @"Exposure is not supported on a simulator.", nil);
        return;
    #endif
    ...
    [self.bridge.uiManager addUIBlock:^(__unused RCTUIManager *uiManager, NSDictionary<NSNumber *, RNCamera *> *viewRegistry) {
        ...
        if (![view isKindOfClass:[RNCamera class]]) {
            ...
            float exposureValue = [view getExposure];
            if (exposureValue != 0) {
                resolve(@(exposureValue));
            } else {
                reject(@"E_GET_EXPOSURE_FAILED", @"Exposure not found or is zero.", nil);
            }
        }
    }];
}
